...
We have setup a version of RStudio that STA130 students can access from any web browser at http://rstudio.chass.utoronto.ca/. This can be used for all computing in the course.  Only STA130H1S students will have access. This has all R libraries installed that you will require to complete course assignments. 
