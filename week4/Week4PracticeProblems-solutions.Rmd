...
Our test statistic is $53/80=0.6625$.  There are no dots in the plot that are at a value greater than or equal to 0.6625 or less than or equal to 0.3375.  (0.3375 is the same distance below 0.5 that 0.6625 is above it.)  So the estimate of the P-value is 0. (Note that it's not actually 0, but 0 to many decimal places.  Since we did 100 repetitions in this plot, the P-value is $<.01.$)
