...
5. Look for the file "Week3PracticeProblems-student.Rmd" under the Files tab then click on it to open.

6. Change the subtitle to "Week 3 Practice Problems Solutions" and change the author to your name and student number.
...
```{r,eval=FALSE}
file_url <- "https://raw.githubusercontent.com/ntaback/UofT_STA130/master/Fall2018/week3/tutorial/Week3PracticeProblems_student.Rmd"
download.file(url = file_url , destfile = "Week3PracticeProblems-student_temp.Rmd")
```
