...
__Question:__ Can the severity score be derived from other variables in the data set?

__Answer:__  No.  The severity score cannot be derived from other variables in the data set.

__Question:__ Is it correct to say that there is no data on the number of people involved in an incident?  So, for example, we can’t assume anything about the number of people involved in a multi-passenger vehicle incident or any other incident.

__Answer:__ Yes.

__Question:__ What is the definition of multi-passenger vehicle?

__Answer:__  MPV or multi-purpose vehicles is a classification specified by the car manufacturer. SUV and vans are also included this classification.
