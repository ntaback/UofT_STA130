...
5. Look for the file "Week9PracticeProblems_questions.Rmd" under the Files tab then click on it to open.

6. Change the subtitle to "Week9PracticeProblemsSolutions" and change the author to your name and student number.
...
```{r,eval=FALSE}
file_url <- "https://raw.githubusercontent.com/ntaback/UofT_STA130/master/Fall2018/week9/Tutorial/Week9PracticeProblems_questions.Rmd"
download.file(url = file_url , destfile = "Week9PracticeProblems_student.Rmd")
```

You will need to install several libraries such as `tidyverse`, and `mosaic` to complete the questions.

Look for the file "Week9PracticeProblems_student.Rmd" under the Files tab then click on it to open.