...
## Poster Content and Reproducability
...
- If the R Markdown file is submitted after the deadline then every member of your group will lose 10% of your overall final project mark.  If the R Markdown file is submitted more than 24 hours past the due date then  
...
- During the poster fair, you will be visited by members of the STA130H1 teaching team.  You will give them a 5 minute presentation about your work.  The rubric for the oral presentation is [here](STA130_project_oral_presentation_rubric.pdf).  The oral presentation mark will comprise 40% of your mark for the project.

- You will be evaluated as a team.

- If a student in a group isn’t present or late for their group’s presentation then they will need a valid excuse (e.g., UofT illness form), otherwise they will receive 50% of the group mark.
...
You will carry out a statistical analysis on data from [Geotab](https://www.geotab.com) to address the topic below.  
