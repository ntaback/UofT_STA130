...
- You will not be required to write `R` code.  However you may be required to read and interpret `R` code, make small modifications to code, and know what the functions being used do.
- The content of the course has changed significantly from last year (and the year before), so past tests are unlikely to be of value to you.  We'll ppost some additional practice problems before the test.
