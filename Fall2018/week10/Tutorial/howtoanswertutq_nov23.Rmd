...
3. Click on November23Tutorial.

![](rstudiocloudscreenshot.png)

4. Look for the file "practice_probs_nov23.Rmd" under the Files tab then click on it to open.

5. Change the subtitle to "Week10PracticeProblemsSolutions" and change the author to your name and student number.
...
```{r,eval=FALSE}
file_url <- "https://raw.githubusercontent.com/ntaback/UofT_STA130/master/Fall2018/week10/Tutorial/practice_probs_nov23.Rmd"
