...
```{r,warning=FALSE,message=FALSE,echo=TRUE, fig.height=2, fig.width=8}
...
```{r,echo=TRUE}
# uncomment this next line if fivethirtyeight lib is not installed 
...
<img src="poll1.png" style="width:8in;height:8in;">
