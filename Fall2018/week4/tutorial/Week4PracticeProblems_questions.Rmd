...
(b) Assume you conduct a hypothesis test using simulation and get the following empirical distribution for values of the test statistic $\hat{p}$, assuming the null hypothesis is true. For simplicity, this distribution only shows the results of 100 simulations. There are 500 dots on the plot, one for each simulation (note that in practice, 500 simulations is not sufficient).  What does each dot on the plot represent?
