...
5. Look for the file "Week6PracticeProblems_questions.Rmd" under the Files tab then click on it to open.

6. Change the subtitle to "Week6PracticeProblemsSolutions" and change the author to your name and student number.
...
```{r,eval=FALSE}
file_url <- "https://raw.githubusercontent.com/ntaback/UofT_STA130/master/Fall2018/week6/Tutorial/Week6PracticeProblems_student.Rmd"
download.file(url = file_url , destfile = "Week6PracticeProblems_student.Rmd")
```

You will need to install several libraries such as `tidyverse`, and `mosaic` to complete the questions.

Look for the file "Week6PracticeProblems_student.Rmd" under the Files tab then click on it to open.