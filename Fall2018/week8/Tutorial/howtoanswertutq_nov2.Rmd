...
5. Look for the file "Week8PracticeProblems_questions.Rmd" under the Files tab then click on it to open.

6. Change the subtitle to "Week8PracticeProblemsSolutions" and change the author to your name and student number.
...
```{r,eval=FALSE}
file_url <- "https://raw.githubusercontent.com/ntaback/UofT_STA130/master/Fall2018/week8/Tutorial/practice_probs_nov2_solutions.Rmd"
download.file(url = file_url , destfile = "Week8PracticeProblems_student.Rmd")
```
